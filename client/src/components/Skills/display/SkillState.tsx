import { FileText, TriangleAlert, MousePointerClick } from 'lucide-react';
...
const icons: Record<SkillStateVariant, typeof FileText> = {
  ...
  return (
    <div className={cn('flex h-full w-full items-center justify-center px-6 py-12', className)}>
      <div className="flex max-w-sm flex-col items-center text-center">
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-text-tertiary">{description}</p>
